...
* `complete` : completes a request which means creating and returning a response from the arguments which can be different combinations of an HTTP status code, an object to "marshall" into a response body using a marshaller parameter.
